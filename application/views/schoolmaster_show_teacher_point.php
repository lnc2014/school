...
<div class="place">
    ...
    <ul class="placeul">
        <li><a href="#">首页</a></li>
        <li><a href="#">校长查看积点详情页面</a></li>
    </ul>
</div>

<div id="first_div">
    <b>当前页面：</b>校长查看积点详情页面
    <button href="#" class="btn_primary" onclick = "javascript:window.location.href='/index.php/academic/index' ">返回列表</button>
</div>
