...
<div class="place">
    ...
    <ul class="placeul">
        <li><a href="#">首页</a></li>
        <li><a href="#">教务处审核积点详情页面</a></li>
    </ul>
</div>

<div id="first_div">
    <b>当前页面：</b>教务处审核积点详情页面
    <button href="#" class="btn_primary" onclick = "javascript:window.location.href='/index.php/academic/index' ">返回审核列表</button>
</div>
