...
<!--                            1为教师队伍，没有所属部门，2为教务处成员，3办公室成员，4为评审委员会成员,5为校长-->
                ...
                <li><label>是否部门主任<b>*</b></label>
                    <div class="vocation">
                        <select class="select2" id="is_department">
                            <!--                            1为教师队伍，没有所属部门，2为教务处成员，3办公室成员，4为评审委员会成员,5为校长-->
                            <option value="0" <?php if($teacher['is_admin'] == 0){ echo 'selected';} ?>>否</option>
                            <option value="1" <?php if($teacher['is_admin'] == 1){ echo 'selected';} ?>>是</option>
                        </select>
                    </div>
                </li>
    ...
    <script type="text/javascript">
        function submit2(){
            ...
            var is_department = $('#is_department').val();
            if(!mobile){
                alert('手机号码不能为空！');
                return;
            }
            ...
            $.ajax({
                type: "POST",
                url: "/index.php/system/save_teacher_info",
                data: {
                    is_update : is_update,
                    mobile : mobile,
                    name : name,
