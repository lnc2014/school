...
<div class="place">
    ...
    <ul class="placeul">
        <li><a href="#">首页</a></li>
        <li><a href="#">评审委员会审核积点详情页面</a></li>
    </ul>
</div>

<div id="first_div">
    <b>当前页面：</b>评审委员会审核积点详情页面
    <button href="#" class="btn_primary" onclick = "javascript:window.location.href='/index.php/committee/index' ">返回审核列表</button>
</div>
...
<div class="div_border">
    ...
    <div class="option" id="base_point" >
        ...
        <input type="checkbox" disabled <?php if($teacher_point['workload'] == 1){ echo 'checked';}?> value="1" class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" disabled <?php if($teacher_point['workload'] == 0){ echo 'checked';}?> value="0" class="no"/>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select4" disabled id="is_section_leader" style="width: 250px">
    ...
    <div class="option" id="director">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['director'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['director'] == 0){ echo 'checked';}?> class="no"/>
    ...
    <div class="option" id="officer">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['officer'] == 1){ echo 'checked';}?>  class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0"  disabled <?php if($teacher_point['officer'] == 0){ echo 'checked';}?> class="no"/>
    ...
    <div class="option" id="school_leader">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['school_leader'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['school_leader'] == 0){ echo 'checked';}?>  class="no"/>
    ...
    <div class="option" id="part_time_magazine">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['part_time_magazine'] == 1){ echo 'checked';}?>  class="yes"/>
        <?php if(!empty($teacher_point['part_time_magazine'])){
            echo '<a target="_blank" style="margin-left: 10px" href="http://'.$_SERVER['HTTP_HOST']."/".$teacher_point['part_time_magazine_data'].'">点击预览兼职证明文件</a>';
        }?>
        <input type="hidden" id="part_time_magazine_upload_data" value="<?php echo $teacher_point['part_time_magazine_data'];?>"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['part_time_magazine'] == 0){ echo 'checked';}?>  class="no"/>
    ...
    <div class="option" id="academic">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['academic'] == 1){ echo 'checked';}?>  class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['academic'] == 0){ echo 'checked';}?> class="no"/>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select2" disabled id="education_case" style="width: 250px">
                <option value="0"  selected>不是</option>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select2" disabled id="paper" style="width: 250px">
    ...
    <div class="option" id="eight_teacher">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['eight_teacher'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['eight_teacher'] == 0){ echo 'checked';}?> class="no" />
    ...
    <div class="option" id="league_teacher">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['league_teacher'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['league_teacher'] == 0){ echo 'checked';}?> class="no"/>
        <label class="label2">积点数：5</label>
        <span style="margin-top: 20px"><b style="color: red">积点说明：</b>无</span>
    </div>
    <div class="option" id="tutor">
        ...
        <label class="label">是</label>
        <input type="checkbox"  value="1" disabled <?php if($teacher_point['tutor'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox"  value="0" disabled <?php if($teacher_point['tutor'] == 0){ echo 'checked';}?> class="no"/>
        <label class="label2">积点数：5</label>
        <span style="margin-top: 20px"><b style="color: red">积点说明：</b>无</span>
    </div>
    <div class="option">
        ...
        <div class="vocation">
            <select class="select2" disabled id="union" style="width: 250px">
                <option value="0" selected>不是</option>
    ...
    <div class="option" id="join_festival">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['join_festival'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['join_festival'] == 0){ echo 'checked';}?> class="no"/>
    ...
    <div class="option" id="counselor">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['counselor'] == 1){ echo 'checked';}?> class="yes" />
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['counselor'] == 0){ echo 'checked';}?> class="no" />
        <label class="label2">积点数：5</label>
        <span style="margin-top: 20px"><b style="color: red">积点说明：</b>无</span>
    </div>
    <div class="div_title">
    ...
    <div class="option" id="substitute">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['substitute'] == 1){ echo 'checked';}?> class="yes"/>
        <input type="text" placeholder="代课节数" disabled class="input_text" style="width: 82px" id="substitute_num" value="<?php if($teacher_point['substitute_num'] > 0){echo $teacher_point['substitute_num'];} ?>" />
        <?php if(!empty($teacher_point['substitute_data'])){
            echo '<a target="_blank" style="margin-left: 100px" href="http://'.$_SERVER['HTTP_HOST']."/".$teacher_point['substitute_data'].'">点击预览兼职证明文件</a>';
        }?>
        <label class="label" style="margin-left: 200px" >否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['substitute'] == 0){ echo 'checked';}?> class="no"/>
        <label class="label2">积点数：见积点说明</label>
    ...
    <div class="option" id="satisfaction_survey">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['satisfaction_survey'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['satisfaction_survey'] == 0){ echo 'checked';}?> class="no"/>
        <label class="label2">积点数：5</label>
    ...
    <div class="option" id="attendance_award">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled class="yes" <?php if($teacher_point['attendance_award'] == 0){ echo 'checked';}?> />
        <?php if(!empty($teacher_point['attendance_award_data'])){
            echo '<a target="_blank" style="margin-left: 100px" href="http://'.$_SERVER['HTTP_HOST']."/".$teacher_point['substitute_data'].'">点击预览出勤证明文件</a>';
        }?>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled class="no" <?php if($teacher_point['attendance_award'] > 0){ echo 'checked';}?> />
    ...
    <div class="option" id="school_teacher">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['school_teacher'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['school_teacher'] == 0){ echo 'checked';}?> class="no" />
    ...
    <div class="option" id="finish_goal">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" disabled <?php if($teacher_point['finish_goal'] == 1){ echo 'checked';}?> class="yes"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['finish_goal'] == 0){ echo 'checked';}?> class="no"/>
        <label class="label2">积点数：5</label>
    ...
    <div class="option" id="college">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" class="yes" disabled <?php if($teacher_point['college_num'] > 0){ echo 'checked';}?>  />
        <input type="text" placeholder="超出指标数量" disabled class="input_text" style="width: 150px" id="college_num" value="<?php if($teacher_point['college_num'] > 0){ echo $teacher_point['college_num'];}?>"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled  class="no" <?php if($teacher_point['college_num'] == 0){ echo 'checked';}?> />
        <label class="label2">积点数：见积点说明</label>
    ...
    <div class="option" id="middle">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1"  disabled <?php if($teacher_point['middle_num'] > 0){ echo 'checked';}?>  class="yes"/>
        <input type="text" placeholder="超出指标数量" disabled class="input_text" style="width: 100px" id="middle_num" value="<?php if($teacher_point['middle_num'] > 0){ echo $teacher_point['middle_num'];}?>" />
        <label class="label">否</label>
        <input type="checkbox" value="0" disabled <?php if($teacher_point['middle_num'] == 0){ echo 'checked';}?>  class="no"/>
        <label class="label2">积点数：见积点说明</label>
    ...
    <div class="option" id="super_workload">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" class="yes" disabled <?php if($teacher_point['super_workload'] > 0){ echo 'checked';}?> />
        <input type="text" placeholder="超出节课数" disabled  class="input_text" style="width: 100px" id="super_workload_num" value="<?php if($teacher_point['super_workload'] > 0){ echo $teacher_point['super_workload'];}?>" />
        <label class="label">否</label>
        <input type="checkbox" value="0" class="no" disabled <?php if($teacher_point['super_workload'] == 0){ echo 'checked';}?> />
        <label class="label2">积点数：见积点说明</label>
    ...
    <div class="option" id="school_class">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" class="yes" disabled <?php if($teacher_point['school_class'] > 0){ echo 'checked';}?> />
        <input type="text" placeholder="节课数" disabled class="input_text" style="width: 100px" id="school_class_num" value="<?php if($teacher_point['school_class'] > 0){ echo $teacher_point['school_class'];}?>" />
        <label class="label">否</label>
        <input type="checkbox" value="0" class="no" disabled <?php if($teacher_point['school_class'] == 0){ echo 'checked';}?>  />
        <label class="label2">积点数：见积点说明</label>
    ...
    <div class="option" id="city_class">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" class="yes" disabled <?php if($teacher_point['city_class'] > 0){ echo 'checked';}?>/>
        ...
        <label class="label">否</label>
        <input type="checkbox" value="0" class="no" disabled <?php if($teacher_point['city_class'] == 0 ){ echo 'checked';}?> />
        <label class="label2">积点数：见积点说明</label>
    ...
    <div class="option" id="courses">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" class="yes" disabled <?php if($teacher_point['courses'] > 0){ echo 'checked';}?>/>
        <input type="text" placeholder="节课数" disabled class="input_text" style="width: 100px" id="courses_num" value="<?php if($teacher_point['courses'] > 0){ echo $teacher_point['courses'];}?>"/>
        <label class="label">否</label>
        <input type="checkbox" value="0" class="no" disabled <?php if($teacher_point['courses'] == 0){ echo 'checked';}?>/>
        <label class="label2">积点数：见积点说明</label>
    ...
    <div class="option">
        ...
        <input type="text" placeholder="学生进入国家集训队的个数" disabled class="input_text" style="width: 200px" id="country_match_num" value="<?php echo $teacher_point['country_match'];?>" />
        <input type="text" placeholder="学生进入省级的个数" disabled class="input_text" style="width: 150px" id="province_match_num" value="<?php echo $teacher_point['province_match'];?>" />
        <input type="text" placeholder="学生进入市级的个数" disabled class="input_text" style="width: 150px" id="city_match_num" value="<?php echo $teacher_point['city_match'];?>" />
        <label class="label2">积点数：见积点说明</label>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select2" disabled id="exam_pro">
                <option value="0" selected>无</option>
    ...
    <div class="option" id="exam_rank">
        ...
        <label class="label">是</label>
        <input type="checkbox" value="1" class="yes" disabled <?php if($teacher_point['exam_rank'] == 1){ echo 'checked';}?>/>
        <?php if(!empty($teacher_point['exam_rank_data'])){
            echo '<a target="_blank" style="margin-left: 10px" href="http://'.$_SERVER['HTTP_HOST']."/".$teacher_point['exam_rank_data'].'">点击预览兼职证明文件</a>';
        }?>
        <label class="label" >否</label>
        <input type="checkbox" value="0" disabled class="no" <?php if($teacher_point['exam_rank'] == 0){ echo 'checked';}?>/>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select6" disabled id="outstand_sub" style="width: 250px">
                <option value="0" selected>不是</option>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp;
        <?php if(!empty($teacher_point['outstand_sub_data'])){
            echo '<a target="_blank" style="margin-left: 10px" href="http://'.$_SERVER['HTTP_HOST']."/".$teacher_point['outstand_sub_data'].'">点击预览兼职证明文件</a>';
        }?>
        <br>
        <label class="label2" >积点数：见积点说明</label>
        <br>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select4" disabled id="select_outstand_school" >
                <option value="0" selected>不是</option>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select4" disabled id="select_outstand_year">
                <option value="0" selected>不是</option>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select4" disabled id="select_outstand_person">
                <option value="0" selected>不是</option>
    ...
    <div class="option">
        ...
        <div class="vocation">
            <select class="select4" disabled id="expert">
                <option value="0" selected>不是</option>
    ...
    <div class="option">
        ...
        <input class="input_text" disabled id="work_year" value="<?php echo $teacher_point['work_year']?>" type="text" placeholder="竞聘人员参加工作之月" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
        <br>
        <label class="label2" >积点数：见积点说明</label>
        <br>
    ...
    <div class="option">
        ...
        <input class="input_text" disabled id="city_year" value="<?php echo $teacher_point['city_year']?>" type="text" placeholder="竞聘人员正式调入我市工作之月" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
        <br>
        <label class="label2" >积点数：见积点说明</label>
        <br>
    ...
    <div class="option">
        ...
        <input class="input_text" disabled id="job_title_time" value="<?php echo $teacher_point['job_title']?>" type="text" placeholder="专业技术职称资格时间" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
        <br>
        <label class="label2" >积点数：见积点说明</label>
        <br>
    ...
    <div style="margin-bottom: 20px">
        ...
        <div class="vocation">
            <select class="select5" disabled id="postgraduate">
                <option value="0" selected>不是</option>
    ...
    <a class="btn_primary" style="margin-left: 20px" href="/index.php/academic/index" >返回</a>
    <button class="btn_primary" style="margin-left: 20px" id = "submit_check">通过审核</button>
</div>
